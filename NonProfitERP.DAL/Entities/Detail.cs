...
public partial class Detail : Entity
{
    public Detail()
    {
        ...
        SchoolSchoolTypes = new HashSet<School>();
        SchoolSyllabi = new HashSet<School>();
    ...
    public virtual ICollection<School> SchoolSchoolTypes { get; set; } = new List<School>();

    public virtual ICollection<School> SchoolSyllabi { get; set; } = new List<School>();
